...
RSpec.describe 'new application' do
  before(:each) do
    ...
    @pet_application = PetApplication.create!(pet: @pet_1, application: @application, status: :pending)
    @pet_application = PetApplication.create!(pet: @pet_2, application: @application, status: :pending)
    @pet_application = PetApplication.create!(pet: @pet_3, application: @application, status: :pending)
    @pet_application = PetApplication.create!(pet: @pet_4, application: @application, status: :pending)
  end
