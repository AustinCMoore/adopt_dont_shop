...
RSpec.describe 'the application update' do
  ...
  it "clicks on a returned pet and the pet is added to the application" do
    ...
    # pet_application_1 = PetApplication.create!(pet: pet_1, application: application, status: :pending)
    # pet_application_2 = PetApplication.create!(pet: pet_2, application: application, status: :pending)
